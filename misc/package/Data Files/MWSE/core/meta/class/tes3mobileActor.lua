...
--- @param attackType number? *Optional*. The physical attack type to use for melee weapons (slash, chop, thrust). Maps to values in [`tes3.physicalAttackType`](https://mwse.github.io/MWSE/references/physical-attack-types/) namespace. When not specified, it uses a weighted random attack type for NPCs and creatures.
--- @return boolean result No description yet available.
function tes3mobileActor:forceWeaponAttack(attackType) end
