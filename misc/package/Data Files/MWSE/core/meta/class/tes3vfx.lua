...
--- @field attachNode niBillboardNode|niCollisionSwitch|niNode|niSortAdjustNode|niSwitchNode|nil The node the VFX was created to attach to, if it was created for node attachment.
...
--- @field effectNode niBillboardNode|niCollisionSwitch|niNode|niSortAdjustNode|niSwitchNode The cloned node of the associated `effectObject`.
