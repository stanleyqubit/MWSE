...
BOOL DialogCSSESettings::OnInitDialog() {
	...
	groupRenderWindow->AddSubItem(new CDataBoundPropertyGridProperty("Update Time (ms)", &se::cs::settings.render_window.milliseconds_between_updates, "The number of miliseconds between frame update attempts. By default the window uses a value of 40ms (25 FPS). To update at 60 FPS, use a value of 16."));
