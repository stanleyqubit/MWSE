...
--- @field sceneNode niBillboardNode|niCollisionSwitch|niNode|niSortAdjustNode|niSwitchNode *Read-only*. The scene graph node for the landscape. Contains sub nodes for land patches.
