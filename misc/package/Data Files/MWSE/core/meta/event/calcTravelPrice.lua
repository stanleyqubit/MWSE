...
--- @field companions tes3mobileCreature[]|tes3mobileNPC[]|tes3mobilePlayer[]|nil *Read-only*. Companions that will travel with the player, or `nil` if no companions are present.
