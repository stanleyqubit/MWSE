return {
	...
	arguments = {{
		...
		tableParams = {
			...
			{ name = "owner", type = "tes3npc|tes3npcInstance|tes3mobileNPC|tes3mobileCreature|tes3reference|tes3faction|string", description = "Assigns this NPC or a faction as the owner of the reference." },
