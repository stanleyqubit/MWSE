...
--- @field attackerMobile tes3mobileCreature|tes3mobileNPC|tes3mobilePlayer *Read-only*. The mobile that is attacking.
...
--- @field targetMobile tes3mobileCreature|tes3mobileNPC|tes3mobilePlayer *Read-only*. The mobile that is being attacked.
